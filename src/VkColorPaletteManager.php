	...
	public static function inline_css() {
		...
		foreach ( $colors as $key => $color ) {
			if ( ! empty( $color['color'] ) ) {
				...
				$dynamic_css .= ':root .has-' . $color['slug'] . '-color { color:var(--' . $color['slug'] . ') !important; }';
				$dynamic_css .= ':root .has-' . $color['slug'] . '-background-color { background-color:var(--' . $color['slug'] . ') !important; }';
				$dynamic_css .= ':root .has-' . $color['slug'] . '-border-color { border-color:var(--' . $color['slug'] . ') !important; }';
			}
		}
